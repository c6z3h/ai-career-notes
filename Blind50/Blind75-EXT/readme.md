...
| --- | --- | --- | --- |
| 1 | <ul><li>[x] Fibonacci number</li><li>[x] N-th tribonacci number</li></ul> | <ul><li>[x] Single number(XOR^)</li><li>[x] Majority element</li><li>[x] 3Sum</li></ul> | (Binary search)<ul><li>[x] Binary search</li><li>[x] First bad version</li><li>[x] Search insert position</li></ul>
...
| 5 | <ul><li>[x] Maximum Subarray</li><li>[ ]!Maximum Sum Circular Subarray</li></ul> | <ul><li>Increasing Triplet Subsequence</li><li>[x] Product of Array Except Self</li><li>Subarray Sum Equals K</li></ul> | (Two pointer)<ul><li>[x] Middle of the Linked List</li><li>[x] Remove Nth Node From End of List</li></ul>  
...
| 8 | <ul><li>[ ] Best Time to Buy and Sell Stock with Cooldown</li><li>[ ] Best Time to Buy and Sell Stock with Transaction Fee</li></ul> | <ul><li>[x] Group Anagrams</li><li>[x] Multiply Strings</li></ul> | (Breadth-First Search / Depth-First Search)<ul><li>[ ] Merge Two Binary Trees</li><li>[ ] Populating Next Right Pointers in Each Node</li></ul> 
...
| 14 | <ul><li>Matrix Block Sum</li><li>Range Sum Query 2D - Immutable</li></ul> | <ul><li>[x] Min Stack</li><li>[x] Minimum Remove to Make Valid Parentheses</li><li>Find the Winner of the Circular Game</li></ul> | (Bit Manipulation)<ul><li>[x] Reverse Bits</li><li>[x] Single Number</li></ul> 
| 15 | <ul><li>[x] Unique Paths</li><li>[x] Unique Paths II</li></ul> | <ul><li>Convert Sorted Array to Binary Search Tree</li><li>Construct Binary Tree from Preorder and Inorder Traversal</li><li>Binary Tree Zigzag Level Order Traversal</li></ul> | 
| 16 | <ul><li>[x] Minimum Path Sum</li><li>Maximal Square</li></ul> | <ul><li>Binary Tree Right Side View</li><li>Path Sum II</li><li>Delete Node in a BST</li></ul> |  
| 17 | <ul><li>[ ] Longest Palindromic Substring</li><li>[ ] Longest Palindromic Subsequence</li></ul> | <ul><li>Kth Smallest Element in a BST</li><li>[ ] Binary Search Tree Iterator</li></ul> | 
| 18 | <ul><li>Longest Increasing Subsequence</li><li>Wiggle Subsequence</li></ul> | <ul><li>Lowest Common Ancestor of a Binary</li><li>Serialize and Deserialize Binary Tree</li></ul> | 
